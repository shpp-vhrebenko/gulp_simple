 ...
 <body>
            ...
            <nav class="nav col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav menu-list__nav">
                       <li class="active menu-list__item" ><a href="#">Главная</a></li>
                       <li class="menu-list__item" ><a href="#">Товары и услуги</a></li>
    ...
    <div class="content container">
        <div class="row carousel">
                 ...
                 <div class="carousel-inner" role="listbox">
                     <div class="item active">
                         ...
                         <div class="carousel-caption">
                             <p>Спальня</p>
                             <a href="#">SIENA AVORIO <span>&#62;</span></a>
                         </div>
                     </div>
                     <div class="item">
             ...
             <a href="#" class="look_all_products">Смотреть все товары  &#62;</a>
        </div>
        <div class="row gallery">
             ...
             <div class="gallery_product col-lg-4 col-md-4 col-sm-6 col-xs-12">
                 <div class="overlay"></div>
                 <h4 class="product_name">гостиные</h4>
                 <img src="images/slider_item.jpg" class="img-responsive">
             </div>
