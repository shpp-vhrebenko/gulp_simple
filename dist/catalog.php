...
?>
 ...
 <body>
    ...
    <div class="path-navigation container">
        <div class="row navigation">
            <div id="history-bar" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 history-bar">
                <ul class="nav navbar-nav">
                    <li class="history-bar__item"><a href="index.php">Главная &#47;</a></li>
                    <li class="history-bar__item"><a href="products.php">Товары и услуги &#47;</a></li>
                    <li class="history-bar__item"><a href="subdirectory.php">Спальни &#47;</a></li>
                    <li class="history-bar__item"><a href="catalog.php">Класические &#47;</a></li>
                </ul>     
             </div>
        </div>
    </div>
    <div class="content container">
        ...
        <div class="row catalog-products">
             <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 <h1 class="header-title">Спальни</h1>
             </div>            
