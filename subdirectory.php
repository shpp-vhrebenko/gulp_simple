 ...
 <body>
		...
		<div class="content container">
				...
				<div class="row products">
						 ...
						 <div class="product__item col-lg-6 col-md-6 col-sm-6 col-xs-12">
								 <div class="overlay-image">
										 <img src="images/product.png" class="img-responsive image">
								 </div>                 
								 <a class="product_name" href="catalog.php">Современные</a>
						 </div>
						<div class="product__item col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="overlay-image">
										<img src="images/product.png" class="img-responsive image">
								</div>                 
								<a class="product_name" href="catalog.php">Классические</a>
						</div>
				</div>
